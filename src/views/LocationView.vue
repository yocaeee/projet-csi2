        ...
        <v-card>
          ...
          <v-card-text>
            <v-form ref="formAjout">
              ...
              <v-text-field v-model="nouvelleLocation.heureDebut" label="Heure de début" type="time" required></v-text-field>
              <v-text-field v-model="nouvelleLocation.duree" label="Durée (heures)" type="number" required></v-text-field>
              <v-text-field v-model="nouvelleLocation.montantCaution" label="Montant Caution (€)" type="number" required></v-text-field>
              <v-select v-model="nouvelleLocation.etatRetour" :items="['bon', 'endommagé']" label="État Retour" required></v-select>
              ...
              <v-text-field v-model="nouvelleLocation.montantTotal" label="Montant Total (€)" type="number" required></v-text-field>
              <v-text-field v-model="nouvelleLocation.idMateriel" label="ID Matériel" type="number" required></v-text-field>
            </v-form>
          </v-card-text>
          <v-card-actions>
